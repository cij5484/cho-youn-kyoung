...
export const profile = {
  ...
  galleryImages: [
    ...
    {
      src: 'assets/artist/gallery/profile-gallery-35.webp',
      thumbnail: 'assets/artist/gallery/profile-gallery-35-thumb.webp',
      alt: '보라색 한복을 입고 해금을 든 채 정면을 바라보는 조윤경의 프로필 사진',
      ariaLabel: '보라색 한복을 입고 해금을 든 정면 프로필 사진 보기',
      objectPosition: 'center center',
      thumbnailObjectPosition: 'center top',
    },
    {
      src: 'assets/artist/gallery/profile-gallery-36.webp',
      thumbnail: 'assets/artist/gallery/profile-gallery-36-thumb.webp',
      alt: '보라색 한복을 입고 앉아 해금과 활을 든 조윤경의 전신 프로필 사진',
      ariaLabel: '보라색 한복을 입고 앉아 해금과 활을 든 프로필 사진 보기',
      objectPosition: 'center center',
      thumbnailObjectPosition: 'center top',
    },
    {
      src: 'assets/artist/gallery/profile-gallery-37.webp',
      thumbnail: 'assets/artist/gallery/profile-gallery-37-thumb.webp',
      alt: '보라색 한복을 입고 왼쪽을 바라보는 조윤경의 측면 프로필 사진',
      ariaLabel: '보라색 한복을 입고 왼쪽을 바라보는 측면 프로필 사진 보기',
      objectPosition: 'center center',
      thumbnailObjectPosition: 'center top',
    },
    {
      src: 'assets/artist/gallery/profile-gallery-38.webp',
      thumbnail: 'assets/artist/gallery/profile-gallery-38-thumb.webp',
      alt: '보라색 한복을 입고 해금과 함께 뒤쪽 옆모습을 보이는 조윤경의 프로필 사진',
      ariaLabel: '보라색 한복을 입고 해금과 함께 촬영한 뒤쪽 측면 프로필 사진 보기',
      objectPosition: 'center center',
      thumbnailObjectPosition: 'center top',
    },
    {
      src: 'assets/artist/gallery/profile-gallery-39.webp',
      thumbnail: 'assets/artist/gallery/profile-gallery-39-thumb.webp',
      alt: '보라색 한복을 입고 해금과 함께 뒷모습을 보이는 조윤경의 전신 프로필 사진',
      ariaLabel: '보라색 한복을 입고 해금과 함께 촬영한 뒷모습 전신 프로필 사진 보기',
      objectPosition: 'center center',
      thumbnailObjectPosition: 'center top',
    },
    {
