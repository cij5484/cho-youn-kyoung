...
export const performances: Performance[] = [
  {
    ...
    performer: '조윤경',
    featured: false,
    heroImage: 'assets/performances/haegeum-jeongak-2026-09-22/web/home-hero-desktop.webp',
    heroImageMobile: 'assets/performances/haegeum-jeongak-2026-09-22/web/home-hero-mobile.webp',
    ...
    collaborators: [
      {
        ...
        name: '허유진',
        role: '대금',
        image: 'assets/people/heo-yu-jin/portrait.jpg',
        shortBio: '국립부산국악원 기악단 단원. 한양대학교 음악연주학 박사(D.M.A).',
        fullBio: ['現 국립부산국악원 기악단 단원', '한양대학교 음악연주학 박사 (D.M.A)', '제22회 동아국악콩쿨 일반부 대금부문 금상', '국가무형문화재 종묘제례악 이수자', '영남대학교, 부산예술대학교 강사역임'],
  ...
  },
  {
    ...
    performer: '조윤경',
    featured: false,
    heroImage: 'assets/performances/sanjo-gil-2026-08-16/web/home-hero-desktop.webp',
    ...
    archiveMaterials: [
      { label: 'POSTER', viewLabel: 'VIEW POSTER', previewImages: [{ src: 'assets/performances/sanjo-gil-2026-08-16/viewer/poster.webp', alt: '산조길, 둘 공연 포스터' }], downloadUrl: 'assets/performances/sanjo-gil-2026-08-16/downloads/poster.pdf', downloadLabel: 'DOWNLOAD PDF' },
      { label: 'LEAFLET', viewLabel: 'VIEW LEAFLET', previewImages: [{ src: 'assets/performances/sanjo-gil-2026-08-16/viewer/leaflet-outer.webp', alt: '산조길, 둘 리플렛 바깥면', label: 'OUTER' }, { src: 'assets/performances/sanjo-gil-2026-08-16/viewer/leaflet-inner.webp', alt: '산조길, 둘 리플렛 안쪽면', label: 'INNER' }], downloadUrl: 'assets/performances/sanjo-gil-2026-08-16/downloads/leaflet.pdf', downloadLabel: 'DOWNLOAD PDF' },
    ],
  },
  {
    ...
    performer: '조윤경',
    featured: true,
    heroImage: 'assets/performances/haegeum-2026-08-02/web/home-hero-desktop.webp',
    ...
    archiveMaterials: [
      {
        ...
        previewImages: [{ src: 'assets/performances/haegeum-2026-08-02/viewer/poster.webp', alt: '해금, 시대를 잇다 공연 포스터' }],
      ...
      },
      {
        ...
        previewImages: [{ src: 'assets/performances/haegeum-2026-08-02/viewer/leaflet-outer.webp', alt: '해금, 시대를 잇다 리플렛 바깥면', label: 'OUTER' }, { src: 'assets/performances/haegeum-2026-08-02/viewer/leaflet-inner.webp', alt: '해금, 시대를 잇다 리플렛 안쪽면', label: 'INNER' }],
