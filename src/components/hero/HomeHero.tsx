...
type HomeHeroProps = { slide: HomeHeroSlide; isActive: boolean };

export function HomeHero({ slide, isActive }: HomeHeroProps) {
  ...
  return (
    <section className="home-hero" aria-labelledby={`${slide.id}-hero-title`}>
      <div
      ...
      <div className="hero-content" key={isActive ? `${slide.id}-active` : slide.id}>
        <p className="eyebrow">
