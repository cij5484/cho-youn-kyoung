...
| --- | --- | --- | --- | --- | --- |
| 2026-08-02 | 해금, 시대를 잇다 | `haegeum-2026-08-02` | `/performance/haegeum-2026-08-02` | 해금 창작곡 변천을 기록하는 리사이틀형 테마 | `public/assets/performances/haegeum-2026-08-02/`; 일부 공연 전용 출연자는 기존 폴더 유지 |
| 2026-08-16 | 산조길, 둘 | `sanjo-gil-2026-08-16` | `/performance/sanjo-gil-2026-08-16` | 산조길 프로젝트의 마티에르형 공연 상세 테마 | `public/assets/performances/sanjo-gil-2026-08-16/`; HOME Hero는 기존 폴더 유지 |
