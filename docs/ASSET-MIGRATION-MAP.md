...
- 인물은 `people/{person-id}/portrait.jpg`, 아티스트 대표는 `artist/profile/portrait.jpg`, 갤러리는 검증 전 기존 일련번호를 보존한다.
...
| 23 | `public/images/performance/2026-08-16/detail/archive-bottom-background.png` | `public/assets/performances/sanjo-gil-2026-08-16/web/archive-bottom.png` | 이동/이름 변경 | 공연/DETAIL | 현재 역할과 데이터 ID에 맞춘 표준 경로 | `src/styles/sanjo-detail.css:159` | 높음 | 아니오 |
| 24 | `public/images/performance/2026-08-16/detail/guest-artists-background.png` | `public/assets/performances/sanjo-gil-2026-08-16/web/guest-artists.png` | 이동/이름 변경 | 공연/DETAIL | 현재 역할과 데이터 ID에 맞춘 표준 경로 | `src/styles/sanjo-detail.css:122` | 높음 | 아니오 |
...
| 26 | `public/images/performance/2026-08-16/detail/hero-background.png` | `public/assets/performances/sanjo-gil-2026-08-16/web/hero.png` | 이동/이름 변경 | 공연/DETAIL | 현재 역할과 데이터 ID에 맞춘 표준 경로 | `src/styles/sanjo-detail.css:27` | 높음 | 아니오 |
...
| 28 | `public/images/performance/2026-08-16/detail/note-info-background.png` | `public/assets/performances/sanjo-gil-2026-08-16/web/note-info.png` | 이동/이름 변경 | 공연/DETAIL | 현재 역할과 데이터 ID에 맞춘 표준 경로 | `src/styles/sanjo-detail.css:62` | 높음 | 아니오 |
| 29 | `public/images/performance/2026-08-16/detail/program-01-background.png` | `public/assets/performances/sanjo-gil-2026-08-16/web/program-01.png` | 이동/이름 변경 | 공연/DETAIL | 현재 역할과 데이터 ID에 맞춘 표준 경로 | `src/styles/sanjo-detail.css:105` | 높음 | 아니오 |
...
| 31 | `public/images/performance/2026-08-16/detail/program-02-background.png` | `public/assets/performances/sanjo-gil-2026-08-16/web/program-02.png` | 이동/이름 변경 | 공연/DETAIL | 현재 역할과 데이터 ID에 맞춘 표준 경로 | `src/styles/sanjo-detail.css:107` | 높음 | 아니오 |
...
| 36 | `public/images/profile/gallery/profile-gallery-01.jpg` | `public/assets/artist/press/profile-gallery-01.jpg` | 이동 | 사람/프로필 | 현재 역할과 데이터 ID에 맞춘 표준 경로 | `src/data/profile.ts:36`<br>`src/data/profile.ts:37` | 중간 | 아니오 |
| 37 | `public/images/profile/gallery/profile-gallery-02.jpg` | `public/assets/artist/press/profile-gallery-02.jpg` | 이동 | 사람/프로필 | 현재 역할과 데이터 ID에 맞춘 표준 경로 | `src/data/profile.ts:44`<br>`src/data/profile.ts:45` | 중간 | 아니오 |
| 38 | `public/images/profile/gallery/profile-gallery-03.jpg` | `public/assets/artist/press/profile-gallery-03.jpg` | 이동 | 사람/프로필 | 현재 역할과 데이터 ID에 맞춘 표준 경로 | `src/data/profile.ts:52`<br>`src/data/profile.ts:53` | 중간 | 아니오 |
| 39 | `public/images/profile/gallery/profile-gallery-04.jpg` | `public/assets/artist/press/profile-gallery-04.jpg` | 이동 | 사람/프로필 | 현재 역할과 데이터 ID에 맞춘 표준 경로 | `src/data/profile.ts:60`<br>`src/data/profile.ts:61` | 중간 | 아니오 |
| 40 | `public/images/profile/gallery/profile-gallery-05.jpg` | `public/assets/artist/press/profile-gallery-05.jpg` | 이동 | 사람/프로필 | 현재 역할과 데이터 ID에 맞춘 표준 경로 | `src/data/profile.ts:68`<br>`src/data/profile.ts:69` | 중간 | 아니오 |
| 41 | `public/images/profile/gallery/profile-gallery-06.jpg` | `public/assets/artist/press/profile-gallery-06.jpg` | 이동 | 사람/프로필 | 현재 역할과 데이터 ID에 맞춘 표준 경로 | `src/data/profile.ts:76`<br>`src/data/profile.ts:77` | 중간 | 아니오 |
| 42 | `public/images/profile/gallery/profile-gallery-07.jpg` | `public/assets/artist/press/profile-gallery-07.jpg` | 이동 | 사람/프로필 | 현재 역할과 데이터 ID에 맞춘 표준 경로 | `src/data/profile.ts:84`<br>`src/data/profile.ts:85` | 중간 | 아니오 |
| 43 | `public/images/profile/gallery/profile-gallery-08.jpg` | `public/assets/artist/press/profile-gallery-08.jpg` | 이동 | 사람/프로필 | 현재 역할과 데이터 ID에 맞춘 표준 경로 | 직접 참조 없음 | 중간 | 예 |
| 44 | `public/images/profile/gallery/profile-gallery-09.jpg` | `public/assets/artist/press/profile-gallery-09.jpg` | 이동 | 사람/프로필 | 현재 역할과 데이터 ID에 맞춘 표준 경로 | 직접 참조 없음 | 중간 | 예 |
...
| `src/data/profile.ts` | `images/profile/...` | `assets/artist/profile/...`, `assets/artist/press/...` | 대표/갤러리 | 배열의 `src`와 `thumbnail`을 모두 변경; 08/09는 승인 전 추가/삭제 금지 |
...
- 조윤경 대표 사진은 `artist/profile/portrait.jpg`, 01–07은 press로 유지한다. 08/09 중 무엇을 보존할지와 공개 갤러리 추가 여부는 판단 보류이다.
